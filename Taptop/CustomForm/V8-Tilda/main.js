// import { overwriteFields } from './overwriteFields.js' // old
// import { overwriteSubmit } from './overwriteSubmit.js' // old

import { addCaptcha } from './addCaptcha.js'
import { overwriteForm } from './overwriteForm.js' // new
...
const HandlertType = Config?.HandlertType

if (!HandlertType) console.warn('HandlertType not found!')

let containers = []
if (HandlertType === 'Taptop') {
    containers = document.querySelectorAll('[ea-form="container"]')
} else if (HandlertType === 'Tilda') {
...
containers.forEach(container => {
    ...
    // addForm
    const form = overwriteForm(clonedContainer, Config)
